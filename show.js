...
var WritingPad = function () {
    ...
    function initTable() {
        ...
        colorTable =
        '<table border="1" id="myTable" cellspacing="0" cellpadding="0" style="border-collapse: collapse;cursor:pointer;" >'
        + colorTable + '</table>' +
        '<table width=225 border="0" cellspacing="0" cellpadding="0" style="border:1px #000000 solid;border-collapse: collapse;">' +
        '<tr style="height:30px">' +
        '<td colspan=21 bgcolor=#cccccc>' +

        '<table cellpadding="0" cellspacing="1" border="0" style="border-collapse: collapse">' +
        '<tr>' +
        '<td width="3"><input type="text" name="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#000"></td>' +
        '<td width="3"><input type="text" name="HexColor" size="7" style="border:inset 1px;font-family:Arial;"></td>' +
    ...
    function initSignature() {
        ...
        if (window.requestAnimFrame) {
            ...
            signature.jqSignature({ width: 500, height: 200, border: '1px solid red', background: '#fff', lineColor: '#000', lineWidth: 2, autoFit: false });
